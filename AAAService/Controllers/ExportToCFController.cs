...
namespace AAAService.Controllers
{
    ...
    public class ExportToCFController : Controller
    {
        ...
        public ActionResult ExportToExcel()
        {
            ...
            grid.HeaderRow.Cells[4].Text = "CUST. NO. (5)    4";
            grid.HeaderRow.Cells[4].Width = 45;
            ...
            grid.HeaderRow.Cells[6].Text = "Job Location Code (8)       6";
            grid.HeaderRow.Cells[6].Width = 61;
